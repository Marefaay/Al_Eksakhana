...
// let i=0;
// let txt= "ElA gsakhana"
// setInterval(()=>{

// })
//  let typingWords=["El Akskhana" ,"Pharamsy"]
...
// Other Links End
// Show alert Discount Start
let discount = document.querySelector(".offer");
let time = setInterval(() => {
  discount.style.left = "0px";
}, 8000);
// Close Discount Section Start
let clse = document.querySelector(".close");
clse.addEventListener("click", () => {
  discount.style.left = "-5000px";
  clearInterval(time);
});
// Close Discount Section End
// Show alert Discount End
// Card offer start
let cardOffer=document.querySelector(".card-offer")
let offer=setInterval(()=>{
  cardOffer.style.bottom="0px"
},18000)
// Close Offer Card Start
let offerClose=document.querySelector("#close")
console.log(offerClose)
offerClose.addEventListener("click",()=>{
  cardOffer.style.bottom="-5000px"
  clearInterval(offer)
})
// Close Offer Card End
// Card offer End
...
// Statictics Start
// let nums=document.querySelectorAll(".stat-item .num")
// console.log(nums)
// function counter(el){
//   let endVlue=el.dataset.goal
//   console.log(endVlue)

//     let ct=setInterval(()=>{
//       el.innerHTML++;
//       if(el.innerHTML==endVlue){
//         clearInterval(ct)
//       }
//     },10)
//   }
